...
@Composable
internal fun CompletedQuizScreen(
    modifier: Modifier = Modifier,
    viewModel: CompletedQuizViewModel = hiltViewModel(),
) {
    CompletedQuizScreenStateless(modifier = modifier, uiState = viewModel.uiState)
}

@Composable
private fun CompletedQuizScreenStateless(
    modifier: Modifier = Modifier,
...
@Composable
private fun CompletedQuizListCell(
    modifier: Modifier = Modifier,
    title: String,
...
@PreviewPhoneDevice
@Composable
private fun Prev_CompletedQuizListCell() {
...
private fun Prev_Initial() {
    CompletedQuizScreenStateless(uiState = Initial)
}

@PreviewPhoneDevice
@Composable
private fun Prev_Empty() {
    CompletedQuizScreenStateless(uiState = Empty)
}

@PreviewPhoneDevice
@Composable
private fun Prev_Error() {
    CompletedQuizScreenStateless(uiState = Error(errorMessage = "error........."))
}